...
- **1,083 unit tests and 25 integration tests pass**, plus 11 doctests.
- **38 known-bug tests (32 bugs) are pinned as failing tests** (`#[ignore]`d
  with their id); all of them fail today. B-BUILD-1, B-NAV-1, B-RUN-1,
  B-GRP-1, B-GRP-2 and B-PDF-1 have been fixed.
