...
- **1,091 unit tests and 25 integration tests pass**, plus 11 doctests.
- **36 known-bug tests (31 bugs) are pinned as failing tests** (`#[ignore]`d
  with their id); all of them fail today. B-BUILD-1, B-NAV-1, B-RUN-1,
  B-GRP-1, B-GRP-2, B-PDF-1, B-PAIR-1 and B-UI-1 have been fixed.
